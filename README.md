...
- Account/risk/premium/buying-power sizing caps, restart-continuous daily ET limits, conservative bid-based executable P&L, direct/recovered winner states, adverse-path-gated first-passage recovery probability, nondecreasing protected-profit floors, reversal evidence, recovery deadlines, and priority exits.
