...
- Account/risk/premium/buying-power sizing caps, restart-continuous daily ET limits, conservative bid-based executable P&L, resettable soft-profit confirmation, capped nondecreasing soft floors, direct/recovered winner states, adverse-path-gated first-passage recovery probability, full-winner protected-profit floors, reversal evidence, recovery deadlines, and priority exits.
